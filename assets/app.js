...
const app = Vue.reactive({
  ...
  sites: [
    ...
    { label: "AV综合商社", value: "https://wanz-factory.com" },
    { label: "S1-STYLE", value: "https://s1s1s1.com" },
    { label: "创意口袋", value: "https://ideapocket.com" },
    // { label: "MUTEKI", value: "https://mutekimuteki.com" },
    { label: "辣妹", value: "https://kirakira-av.com" },
